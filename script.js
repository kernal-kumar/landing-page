...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.event-card, .speaker-card, .about-content, .contact-content');
...
function initFloatingCards() {
    ...
    floatingCards.forEach(card => {
        card.addEventListener('mouseenter', function() {
            ...
            this.style.transform = 'scale(1.1) translateY(-10px) rotate(5deg)';
        });
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('IKSHANA Event Website loaded successfully!');
